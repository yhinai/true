...
def test_run_compare_direct_invocation_bootstraps_with_uv(tmp_path: Path) -> None:
    ...
    compare_json = reports_root / "compare" / "compare.json"
    compare_markdown = reports_root / "compare" / "compare.md"
